...
public class SelectSensorScreen extends JFrame {
        ...
        private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
                screenbridge.SelecttoConfig("magnetic", 2);
        }// GEN-LAST:event_jButton4ActionPerformed

        private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
                screenbridge.SelecttoConfig("proximity", 4);

        }// GEN-LAST:event_jButton3ActionPerformed

        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed

                screenbridge.SelecttoConfig("optical", 3);

        }// GEN-LAST:event_jButton2ActionPerformed

        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed

                screenbridge.SelecttoConfig("eletromechanical", 1);
